#!/usr/bin/env python3
"""
TikTok Live Interactive Bot - Countries variant entry point

Usage:
    python variants/countries/main.py @username
...
# Project root is three levels up from this file (variants/countries/main.py)
...
def get_username() -> tuple[str, bool]:
        ...
        try:
            try:
                ...
                try:
                    ...
                    pygame.display.set_caption("TikTok Racing Go")
    ...
    print("\n╔═══════════════════════════════════════════╗")
    print("║   TikTok Live Interactive - Countries     ║")
    print("╚═══════════════════════════════════════════╝\n")
