...
ARG_BRA = Matchup(
    ...
    left=TeamDef(
        ...
        escudo_path="assets/versus/images/escudo-argentina.png",
        marcador_path="assets/versus/images/marcador-argentina.png",
    ),
    right=TeamDef(
        name="Brasil",
        short="BRA",
        ...
        escudo_path="assets/versus/images/escudo-brasil.png",
        marcador_path="assets/versus/images/marcador-brasil.png",
    ),
)
